...
const BearSVG = () => {
  ...
  const frames = [
    { lry:5,  rry:5,  lbrow:"M136 136 Q144 132 152 135", rbrow:"M186 135 Q194 132 202 136", mouth:"slight_smile",  blush:0.3, sweat:false, headTilt:0    },
    { lry:3,  rry:3,  lbrow:"M136 133 Q144 130 152 133", rbrow:"M186 133 Q194 130 202 133", mouth:"focus",         blush:0.2, sweat:false, headTilt:-3   },
    { lry:10, rry:10, lbrow:"M136 130 Q144 126 152 130", rbrow:"M186 130 Q194 126 202 130", mouth:"open_shock",    blush:0.5, sweat:false, headTilt:4    },
    { lry:4,  rry:9,  lbrow:"M136 132 Q144 128 152 134", rbrow:"M186 130 Q194 133 202 130", mouth:"confused_wave", blush:0.5, sweat:true,  headTilt:5    },
    { lry:1,  rry:1,  lbrow:"M136 136 Q144 133 152 136", rbrow:"M186 136 Q194 133 202 136", mouth:"slight_smile",  blush:0.3, sweat:false, headTilt:0    },
    { lry:6,  rry:2,  lbrow:"M136 134 Q144 137 152 133", rbrow:"M186 131 Q194 128 202 132", mouth:"squiggle",      blush:0.6, sweat:true,  headTilt:-4   },
  ];
  ...
  return (
    <div style={{ position:"relative", width:"360px", height:"480px", fontFamily:"'Poppins',sans-serif" }}>
      <style>{`
        @keyframes symFloat {
      ...
      <svg viewBox="0 0 360 480" fill="none" xmlns="http://www.w3.org/2000/svg"
        style={{width:"360px", height:"480px", position:"absolute", top:0, left:0}}>

        {/* ══ CHAIR BACK (behind bear body) ══ */}
        <rect x="148" y="270" width="64" height="80" rx="10" fill="#DDD0BC" stroke="#C8B6A6" strokeWidth="1.5"/>
        <rect x="155" y="277" width="50" height="66" rx="7"  fill="#E8DDD0"/>

        {/* ══ BEAR LOWER BODY (sits on chair seat, clipped behind table) ══ */}
        {/* This is drawn BEFORE the table so table overlaps it */}
        <ellipse cx="180" cy="355" rx="48" ry="26" fill="#A0785A" stroke="#8B6040" strokeWidth="1.5"/>

        {/* BODY */}
        <ellipse cx="180" cy="300" rx="50" ry="58" fill="#A0785A" stroke="#8B6040" strokeWidth="2"/>
        {/* tummy patch */}
        <ellipse cx="180" cy="315" rx="28" ry="34" fill="#C8A882" stroke="#B89060" strokeWidth="1"/>

        {/* NECK */}
        <rect x="162" y="240" width="36" height="24" rx="10" fill="#A0785A"/>

        {/* ══ TABLE (drawn OVER lower body so bear appears behind it) ══ */}
        <rect x="28" y="340" width="304" height="16" rx="8" fill="#E8DDD0" stroke="#C8B6A6" strokeWidth="1.5"/>
        {/* table front edge highlight */}
        <rect x="30" y="340" width="300" height="5" rx="4" fill="#F0E8E0" opacity="0.6"/>

        {/* ══ ARMS — resting ON table surface ══ */}
        {/* Left arm: comes from bear body, elbow on table */}
        <ellipse cx="132" cy="332" rx="28" ry="14" fill="#A0785A" stroke="#8B6040" strokeWidth="1.5" transform="rotate(-10 132 332)"/>
        {/* Left paw flat on table */}
        <ellipse cx="122" cy="340" rx="16" ry="10" fill="#B08870" stroke="#8B6040" strokeWidth="1.2"/>

        {/* Right arm */}
        <ellipse cx="228" cy="332" rx="28" ry="14" fill="#A0785A" stroke="#8B6040" strokeWidth="1.5" transform="rotate(10 228 332)"/>
        {/* Right paw flat on table */}
        <ellipse cx="238" cy="340" rx="16" ry="10" fill="#B08870" stroke="#8B6040" strokeWidth="1.2"/>

        {/* table legs */}
        <rect x="42"  y="356" width="12" height="72" rx="6" fill="#DDD0BC"/>
        <rect x="306" y="356" width="12" height="72" rx="6" fill="#DDD0BC"/>
        <rect x="70"  y="356" width="10" height="64" rx="5" fill="#DDD0BC" opacity="0.7"/>
        <rect x="280" y="356" width="10" height="64" rx="5" fill="#DDD0BC" opacity="0.7"/>

        {/* ══ CHAIR SEAT (drawn over bear lap, below table top) ══ */}
        <rect x="138" y="345" width="84" height="14" rx="7" fill="#DDD0BC" stroke="#C8B6A6" strokeWidth="1.5"/>
        {/* chair legs */}
        <rect x="148" y="359" width="10" height="80" rx="5" fill="#C8B6A6"/>
        <rect x="202" y="359" width="10" height="80" rx="5" fill="#C8B6A6"/>
        <rect x="143" y="410" width="35" height="8"  rx="4" fill="#C8B6A6" opacity="0.6"/>
        <rect x="182" y="410" width="35" height="8"  rx="4" fill="#C8B6A6" opacity="0.6"/>

        {/* ══ BOOKS (stacked, left side of table) ══ */}
        <rect x="42" y="312" width="68" height="26" rx="5" fill="#C4A882" stroke="#A08060" strokeWidth="1.2"/>
        <rect x="46" y="312" width="8"  height="26" rx="3" fill="#B89870"/>
        <line x1="54" y1="316" x2="54" y2="334" stroke="#A08060" strokeWidth="1.5"/>
        <line x1="58" y1="319" x2="100" y2="319" stroke="#A08060" strokeWidth="0.8" opacity="0.5"/>
        <line x1="58" y1="325" x2="96"  y2="325" stroke="#A08060" strokeWidth="0.8" opacity="0.5"/>

        <rect x="46" y="290" width="62" height="24" rx="5" fill="#D4B896" stroke="#C8B6A6" strokeWidth="1.2"/>
        <rect x="50" y="290" width="7"  height="24" rx="3" fill="#C4A882"/>
        <line x1="57" y1="294" x2="57" y2="310" stroke="#C8B6A6" strokeWidth="1.5"/>
        <line x1="61" y1="297" x2="97"  y2="297" stroke="#C8B6A6" strokeWidth="0.8" opacity="0.5"/>

        <rect x="50" y="269" width="56" height="23" rx="5" fill="#E8C8A0" stroke="#C8B6A6" strokeWidth="1.2"/>
        <rect x="54" y="269" width="7"  height="23" rx="3" fill="#D4B080"/>
        <line x1="61" y1="273" x2="61" y2="288" stroke="#C8B6A6" strokeWidth="1.5"/>
        <line x1="65" y1="276" x2="97"  y2="276" stroke="#C8B6A6" strokeWidth="0.8" opacity="0.5"/>
        <line x1="65" y1="281" x2="95"  y2="281" stroke="#C8B6A6" strokeWidth="0.8" opacity="0.5"/>

        {/* ══ LAPTOP ══ */}
        {/* screen */}
        <rect x="134" y="268" width="108" height="74" rx="8" fill="#C8C4C0" stroke="#B8B4B0" strokeWidth="1.5"/>
        <rect x="138" y="272" width="100" height="66" rx="5" fill="#E8E6E2"/>
        {/* screen content */}
        <rect x="144" y="278" width="88" height="7"  rx="3" fill="#C8B6A6" opacity="0.45" style={{animation:"screenFlicker 2s ease-in-out infinite"}}/>
        <rect x="144" y="290" width="70" height="4"  rx="2" fill="#C8B6A6" opacity="0.28"/>
        <rect x="144" y="298" width="80" height="4"  rx="2" fill="#C8B6A6" opacity="0.28"/>
        <rect x="144" y="306" width="55" height="4"  rx="2" fill="#C8B6A6" opacity="0.22"/>
        <rect x="144" y="314" width="65" height="4"  rx="2" fill="#C8B6A6" opacity="0.22"/>
        {/* webcam dot */}
        <circle cx="188" cy="275" r="2" fill="#C8B6A6" opacity="0.5"/>
        {/* laptop base / hinge — sits right on table */}
        <rect x="126" y="340" width="124" height="10" rx="5" fill="#C0BCBA" stroke="#B8B4B0" strokeWidth="1"/>
        <rect x="165" y="338" width="46"  height="5"  rx="2" fill="#C8C4C0"/>

        {/* ══ COFFEE CUP ══ */}
        <rect x="265" y="300" width="38" height="34" rx="9" fill="#EDE0D0" stroke="#C8B6A6" strokeWidth="1.5"/>
        <ellipse cx="284" cy="300" rx="19" ry="6" fill="#D8C8B0" stroke="#C8B6A6" strokeWidth="1"/>
        <path d="M303 306 Q315 306 315 315 Q315 325 303 325" stroke="#C8B6A6" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
        <ellipse cx="284" cy="302" rx="14" ry="4" fill="#7A5540" opacity="0.4"/>
        {/* steam */}
        <path d="M274 293 Q277 286 274 279" stroke="#C8B6A6" strokeWidth="1.5" fill="none" strokeLinecap="round"
          style={{animation:"steamUp 1.8s ease-in-out infinite"}}/>
        <path d="M284 291 Q287 284 284 277" stroke="#C8B6A6" strokeWidth="1.5" fill="none" strokeLinecap="round"
          style={{animation:"steamUp 1.8s ease-in-out 0.5s infinite"}}/>
        <path d="M294 293 Q297 286 294 279" stroke="#C8B6A6" strokeWidth="1.5" fill="none" strokeLinecap="round"
          style={{animation:"steamUp 1.8s ease-in-out 0.9s infinite"}}/>

        {/* ══ HEAD (drawn last so it's always on top) ══ */}
        <g transform={`rotate(${fr.headTilt} 180 190)`}>

          {/* head */}
          <ellipse cx="180" cy="182" rx="58" ry="55" fill="#A0785A" stroke="#8B6040" strokeWidth="2"/>

          {/* ears */}
          <circle cx="130" cy="140" r="22" fill="#A0785A" stroke="#8B6040" strokeWidth="2"/>
          <circle cx="130" cy="140" r="13" fill="#C8A882"/>
          <circle cx="230" cy="140" r="22" fill="#A0785A" stroke="#8B6040" strokeWidth="2"/>
          <circle cx="230" cy="140" r="13" fill="#C8A882"/>

          {/* face base / muzzle */}
          <ellipse cx="180" cy="195" rx="26" ry="18" fill="#C8A882"/>
          ...
          {/* EYES */}
          <ellipse cx="152" cy="178" rx="9" ry={fr.lry} fill="#2D1810" style={{transition:"ry 0.2s ease"}}/>
          <ellipse cx="208" cy="178" rx="9" ry={fr.rry} fill="#2D1810" style={{transition:"ry 0.2s ease"}}/>

          {/* Eye shine */}
          {frame !== 4 && <>
            <circle cx="155" cy="174" r="3.5" fill="white"/>
            <circle cx="211" cy="174" r="3.5" fill="white"/>
          </>}
          {frame === 2 && <>
            <circle cx="158" cy="181" r="2"   fill="white" opacity="0.5"/>
            <circle cx="214" cy="181" r="2"   fill="white" opacity="0.5"/>
          </>}

          {/* GLASSES */}
          <circle cx="152" cy="178" r="18" fill="rgba(200,180,160,0.12)" stroke="#5A3820" strokeWidth="2.2"/>
          <circle cx="208" cy="178" r="18" fill="rgba(200,180,160,0.12)" stroke="#5A3820" strokeWidth="2.2"/>
          <line x1="170" y1="178" x2="190" y2="178" stroke="#5A3820" strokeWidth="2.2"/>
          <line x1="134" y1="173" x2="126" y2="168" stroke="#5A3820" strokeWidth="2"/>
          <line x1="226" y1="173" x2="234" y2="168" stroke="#5A3820" strokeWidth="2"/>

          {/* NOSE */}
          <ellipse cx="180" cy="194" rx="9" ry="6" fill="#5A3820"/>
          <ellipse cx="178" cy="192" rx="3" ry="2" fill="#7A5840" opacity="0.5"/>

          {/* MOUTH */}
          {fr.mouth === "slight_smile"  && <path d="M168 202 Q180 211 192 202" stroke="#5A3820" strokeWidth="2.2" fill="none" strokeLinecap="round"/>}
          {fr.mouth === "focus"         && <path d="M170 203 Q180 208 190 203" stroke="#5A3820" strokeWidth="2" fill="none" strokeLinecap="round"/>}
          {fr.mouth === "open_shock"    && <ellipse cx="180" cy="205" rx="10" ry="8" fill="#5A3820" opacity="0.75"/>}
          {fr.mouth === "confused_wave" && <path d="M168 203 Q174 199 180 203 Q186 207 192 203" stroke="#5A3820" strokeWidth="2.2" fill="none" strokeLinecap="round"/>}
          {fr.mouth === "squiggle"      && <path d="M166 203 Q172 197 178 203 Q184 209 190 203 Q194 199 196 201" stroke="#5A3820" strokeWidth="2.2" fill="none" strokeLinecap="round"/>}

          {/* BLUSH */}
          <ellipse cx="136" cy="194" rx="14" ry="8" fill="#E8A090" opacity={fr.blush} style={{transition:"opacity 0.3s"}}/>
          <ellipse cx="224" cy="194" rx="14" ry="8" fill="#E8A090" opacity={fr.blush} style={{transition:"opacity 0.3s"}}/>

          {/* SWEAT DROP */}
          {fr.sweat && (
            <g style={{animation:"sweatDrop 1s ease-in-out infinite"}}>
              <ellipse cx="232" cy="158" rx="5" ry="9" fill="#A8C8E0" opacity="0.7"/>
              <ellipse cx="232" cy="152" rx="4" ry="4" fill="#A8C8E0" opacity="0.5"/>
            </g>
          )}
        </g>

        {/* floor shadow */}
        <ellipse cx="180" cy="442" rx="90" ry="10" fill="#C8B6A6" opacity="0.18"/>
